...
describe('Formatter', () => {
    ...
    describe('getNextNonWhitespaceToken', () => {
        it('returns undefined when index is out of bounds', () => {
            (0, chai_1.expect)(formatter.getNextNonWhitespaceToken([], -1)).to.be.undefined;
        });
    });
    describe('formatIndent', () => {
        ...
        it('properly indents foreach loops', () => {
            formatEqual(`for each item in collection\n    name = true\nend for`);
        });
    ...
    describe('formatMultiLineObjectsAndArrays', () => {
        ...
        it('does not lose trailing line', () => {
            formatEqual(`function GetPerson()\n    person = { exists: true,\n    }\nend function`, `function GetPerson()\n    person = {\n        exists: true,\n    }\nend function`);
        });
    ...
    describe('dedupeWhitespace', () => {
        it('dedupes Whitespace', () => {
            ...
            formatter.dedupeWhitespace(tokens);
    ...
    describe('formatInteriorWhitespace', () => {
        ...
        it('handles malformed function Whitespace', () => {
            (0, chai_1.expect)(formatter.format(`function add`, { formatIndent: false })).to.equal(`function add`);
        });
        it('dedupes extra spaces', () => {
            (0, chai_1.expect)(formatter.format(`
        ...
        it('adds spaces between many known token types', () => {
            (0, chai_1.expect)(formatter.format(`name=name+""`)).to.equal(`name = name + ""`);
            (0, chai_1.expect)(formatter.format(`age+=1`)).to.equal(`age += 1`);
            (0, chai_1.expect)(formatter.format(`age-=1`)).to.equal(`age -= 1`);
            (0, chai_1.expect)(formatter.format(`age*=1`)).to.equal(`age *= 1`);
            (0, chai_1.expect)(formatter.format(`age/=1`)).to.equal(`age /= 1`);
            (0, chai_1.expect)(formatter.format(`age\\=1`)).to.equal(`age \\= 1`);
            (0, chai_1.expect)(formatter.format(`age>>=1`)).to.equal(`age >>= 1`);
            (0, chai_1.expect)(formatter.format(`age<<=1`)).to.equal(`age <<= 1`);
            (0, chai_1.expect)(formatter.format(`age=1+1`)).to.equal(`age = 1 + 1`);
            (0, chai_1.expect)(formatter.format(`age=1-1`)).to.equal(`age = 1 - 1`);
            (0, chai_1.expect)(formatter.format(`age=1*1`)).to.equal(`age = 1 * 1`);
            (0, chai_1.expect)(formatter.format(`age=1/1`)).to.equal(`age = 1 / 1`);
            (0, chai_1.expect)(formatter.format(`age=1\\1`)).to.equal(`age = 1 \\ 1`);
            ...
            (0, chai_1.expect)(formatter.format(`age=1>=1`)).to.equal(`age = 1 >= 1`);
            //spacing after comma
            (0, chai_1.expect)(formatter.format(`sub main(a,b,c)\nend sub`)).to.equal(`sub main(a, b, c)\nend sub`);
            (0, chai_1.expect)(formatter.format(`name=1:age=2`)).to.equal(`name = 1: age = 2`);
            (0, chai_1.expect)(formatter.format(`x=5:print 25; " is equal to"; x^2`)).to.equal(`x = 5: print 25; " is equal to"; x ^ 2`);
        });
        ...
        it('correctly formats negative numbers compared to subtraction', () => {
            (0, chai_1.expect)(formatter.format(`name=2-1`)).to.equal(`name = 2 - 1`);
            (0, chai_1.expect)(formatter.format(`name=-1`)).to.equal(`name = -1`);
            (0, chai_1.expect)(formatter.format(`name=1+-1`)).to.equal(`name = 1 + -1`);
            (0, chai_1.expect)(formatter.format(`sub main(num=-1)\nend sub`)).to.equal(`sub main(num = -1)\nend sub`);
            //DOES remove the Whitespace between them when applicable
            (0, chai_1.expect)(formatter.format(`num = - 1`)).to.equal(`num = -1`);
            (0, chai_1.expect)(formatter.format(`call(a, -1)`)).to.equal(`call(a, -1)`);
            (0, chai_1.expect)(formatter.format(`for   i=-1    to   10`)).to.equal(`for i = -1 to 10`);
            (0, chai_1.expect)(formatter.format(`for   i=-1    to   -1    step   -1`)).to.equal(`for i = -1 to -1 step -1`);
            formatEqual(`a = [1, -24]`);
            formatEqual(`a = [-24]`);
            formatEqual(`a(-24)`);
            ...
            (0, chai_1.expect)(formatter.format(`print - 1 + - 1`)).to.equal(`print -1 + -1`);
        ...
        it('correctly formats negated variable identifier', () => {
            ...
            (0, chai_1.expect)(formatter.format(`value=1-value`)).to.equal(`value = 1 - value`);
            (0, chai_1.expect)(formatter.format(`value=1- -value`)).to.equal(`value = 1 - -value`);
            (0, chai_1.expect)(formatter.format(`value=1- -  value`)).to.equal(`value = 1 - -value`);
            (0, chai_1.expect)(formatter.format(`value=-value- -value`)).to.equal(`value = -value - -value`);
            formatEqual(`while -value < 0\nend while`);
            formatEqual(`if condition and -value <> -1\nend if`);
            formatEqual(`if condition or -1 <> -value\nend if`);
            formatEqual(`if condition and not -1 <> -value\nend if`);
            (0, chai_1.expect)(formatter.format(`if condition and not - 1 <> - value\nend if`)).to.equal(`if condition and not -1 <> -value\nend if`);
            (0, chai_1.expect)(formatter.format(`for i = - buffer to buffer`)).to.equal(`for i = -buffer to buffer`);
            (0, chai_1.expect)(formatter.format(`for   i    =    -    buffer    to    buffer`)).to.equal(`for i = -buffer to buffer`);
            (0, chai_1.expect)(formatter.format(`for i = - buffer to buffer step - stepVal`)).to.equal(`for i = -buffer to buffer step -stepVal`);
            (0, chai_1.expect)(formatter.format(`for i = -     buffer    to    buffer   step  -  stepVal`)).to.equal(`for i = -buffer to buffer step -stepVal`);
        });
...
sub main()
    ...
    if true then
        print "hello"
            ...
            (0, chai_1.expect)(formatter.format(program)).to.equal(program);
        });
        it('ensures Whitespace between numeric literal and `then` keyword', () => {
            (0, chai_1.expect)(formatter.format(`if playlist.indexOf(songEntry) = -1 then`)).to.equal(`if playlist.indexOf(songEntry) = -1 then`);
        });
        ...
        it('formats exactly 1 space between logical operators', () => {
            formatEqual(`if(true  or  false  and  1=1  and  2>1)`, `if(true or false and 1 = 1 and 2 > 1)`);
        });
        ...
        it('disabling the rule works', () => {
            (0, chai_1.expect)(formatter.format(`a=1`)).to.equal('a = 1');
            //disabled
            (0, chai_1.expect)(formatter.format(`a=1`, {
    ...
    describe('indentStyle', () => {
        it('indents enums', () => {
            (0, chai_1.expect)(formatter.format('enum Direction\nup="up"\ndown="down"\nendenum')).to.equal('enum Direction\n    up = "up"\n    down = "down"\nend enum');
        });
        it('indents namespaced enums', () => {
            (0, chai_1.expect)(formatter.format('namespace stuff\nenum Direction\nup="up"\ndown="down"\nend enum\nend namespace')).to.equal('namespace stuff\n    enum Direction\n        up = "up"\n        down = "down"\n    end enum\nend namespace');
        });
        it('correctly fixes indentation for namespace', () => {
            (0, chai_1.expect)(formatter.format('namespace A.B\nsub main()\nend sub\nend namespace')).to.equal('namespace A.B\n    sub main()\n    end sub\nend namespace');
        });
        it('correctly indents class declarations', () => {
            (0, chai_1.expect)(formatter.format('class Person\nsub new()\nend sub\nend class')).to.equal('class Person\n    sub new()\n    end sub\nend class');
        });
        it('correctly indents interface declarations', () => {
            (0, chai_1.expect)(formatter.format('interface Person\nname as string\nend interface')).to.equal('interface Person\n    name as string\nend interface');
        });
        ...
        it('correctly indents multiple interfaces', () => {
            (0, chai_1.expect)(formatter.format('interface IFaceA\na as string\nsub doA()\nend interface\ninterface IFaceB\nb as string\nsub doB()\nend interface')).to.equal('interface IFaceA\n    a as string\n    sub doA()\nend interface\ninterface IFaceB\n    b as string\n    sub doB()\nend interface');
        });
        ...
        it('trims empty lines', () => {
            (0, chai_1.expect)(formatter.format(`sub a()\n    \nend sub`)).to.equal(`sub a()\n\nend sub`);
        });
        ...
        it('skips indentation when formatIndent === false', () => {
            let program = `    sub add(a, b)\nreturn a + b\n    end sub`;
            (0, chai_1.expect)(formatter.format(program, { formatIndent: false })).to.equal(program);
        });
        it('formats single tabs', () => {
            let program = `sub add(a, b)\n\treturn a + b\nend sub`;
            (0, chai_1.expect)(formatter.format(program, { indentStyle: 'tabs' })).to.equal(program);
        });
        it('formats improperly formatted programs', () => {
            (0, chai_1.expect)(formatter.format(`sub add()\nreturn a+b\nend sub`)).to.equal(`sub add()\n    return a + b\nend sub`);
            (0, chai_1.expect)(formatter.format(`    sub add()\n        return a+b\n    end sub`)).to.equal(`sub add()\n    return a + b\nend sub`);
        });
        ...
        it('handles return token properly', () => {
            (0, chai_1.expect)(formatter.format(`sub main()\n if msg.isScreenClosed() then return\n end sub`)).to.equal(`sub main()\n    if msg.isScreenClosed() then return\nend sub`);
        ...
        it('does not double-indent for function keyword used as type', () => {
            (0, chai_1.expect)(formatter.format(`function work(callback as function) as function\n'comment\nend function`)).to.equal(`function work(callback as function) as function\n    'comment\nend function`);
        });
        it('does not double-indent for sub keyword used as type', () => {
            (0, chai_1.expect)(formatter.format(`sub work(callback as sub) as sub\n'comment\nend sub`)).to.equal(`sub work(callback as sub) as sub\n    'comment\nend sub`);
        });
    ...
    describe('indentSpaceCount', () => {
        it('defaults to 4 spaces', () => {
            ...
            (0, chai_1.expect)(formatted.indexOf('    ')).to.equal(11);
        });
        it('allows overriding indentSpaceCount', () => {
            (0, chai_1.expect)(formatter.format(`sub main()\n'comment1\n'comment2\nend sub`, { indentSpaceCount: 2 })).to.equal(`sub main()\n  'comment1\n  'comment2\nend sub`);
        });
        it('handles default when invalid provided', () => {
            (0, chai_1.expect)(formatter.format(`sub main()\n'comment1\n'comment2\nend sub`, { indentSpaceCount: undefined })).to.equal(`sub main()\n    'comment1\n    'comment2\nend sub`);
        });
    });
    describe('special cases', () => {
        ...
        it('it works with identifiers that start with rem', () => {
            (0, chai_1.expect)(formatter.format(`    if (removeFoo <> invalid) then\n        lineups["video"].push(invalid)`)).to.equal(`if (removeFoo <> invalid) then\n    lineups["video"].push(invalid)`);
        });
    ...
    describe('typeCase', () => {
        it('uses keywordCase when not specified', () => {
            (0, chai_1.expect)(formatter.format(`SUB a(name AS STRING, cb AS FUNCTION)`, {
                keywordCase: 'lower'
            })).to.equal(`sub a(name as string, cb as function)`);
        });
        it('only formats types', () => {
            formatEqual(`sub a(name as STRing, age as LIBRARY)`, `sub a(name as string, age as LIBRARY)`, {
                typeCase: 'lower'
            });
        });
        ...
        it('does not format custom types', () => {
            (0, chai_1.expect)(formatter.format(`sub a(person as SomePersonClass)`, {
                typeCase: 'lower'
            })).to.equal(`sub a(person as SomePersonClass)`);
        });
    });
    describe('compositeKeywords', () => {
        it(`works for 'combine'`, () => {
            (0, chai_1.expect)(formatter.format(`elseif`, {
                compositeKeywords: 'combine'
            })).to.equal(`elseif`);
        });
        it(`works for 'combine'`, () => {
            (0, chai_1.expect)(formatter.format(`function a()\nend function`, {
                compositeKeywords: 'combine'
            })).to.equal(`function a()\nendfunction`);
        });
        it(`works for 'split'`, () => {
        ...
        it(`works when not specified`, () => {
            (0, chai_1.expect)(formatter.format(`function a()\nendfunction`, {})).to.equal(`function a()\nend function`);
        });
    ...
    describe('keywordCase', () => {
        ...
        it('works with `as` keyword', () => {
            (0, chai_1.expect)(formatter.format(`sub add(name AS string)\nend sub`, {
                keywordCase: 'lower'
            })).to.equal(`sub add(name as string)\nend sub`);
        });
        ...
        it('formats conditional compile items', () => {
            (0, chai_1.expect)(formatter.format(`#if true then\n#else if true then\n#else\n#end if`, {
                keywordCase: 'title'
    ...
    describe('removeTrailingWhitespace', () => {
        it('removes trailing spaces by default', () => {
            (0, chai_1.expect)(formatter.format(`name = "bob" `)).to.equal(`name = "bob"`);
        });
        ...
        it('removes Whitespace from end of comment', () => {
            (0, chai_1.expect)(formatter.format(`'comment `)).to.equal(`'comment`);
            (0, chai_1.expect)(formatter.format(`'comment\t`)).to.equal(`'comment`);
            (0, chai_1.expect)(formatter.format(`'comment \t`)).to.equal(`'comment`);
            (0, chai_1.expect)(formatter.format(`'comment\t `)).to.equal(`'comment`);
        });
        it('handles multi-line prorgams', () => {
            (0, chai_1.expect)(formatter.format(`name = "bob"\t \nage=22 `)).to.equal(`name = "bob"\nage = 22`);
        });
        it('leaves normal programs alone', () => {
            (0, chai_1.expect)(formatter.format(`name = "bob"\nage=22 `)).to.equal(`name = "bob"\nage = 22`);
        });
        it('skips formatting when the option is set to false', () => {
            (0, chai_1.expect)(formatter.format(`name = "bob" `, { removeTrailingWhiteSpace: false })).to.equal(`name = "bob" `);
        });
    });
    describe('formatKeywordCase', () => {
        describe('typeCaseOverride', () => {
            it('overrides specific types', () => {
                formatEqual(`sub log(name as StRiNg, age as InTeGer)`, `sub log(name as STRING, age as integer)`, {
                    typeCase: 'upper',
                    typeCaseOverride: {
                        'integer': 'lower'
                    }
    ...
    describe('break composite keywords', () => {
        function format(...params) {
            ...
            for (let i = 0; i < params.length; i++) {
                tokens.push((0, brighterscript_1.createToken)(params[i][1], params[i][0]));
            }
        ...
        it('handles edge cases', () => {
            let tokens = formatter.formatCompositeKeywords([{
                    text: 'endfunction',
                    kind: brighterscript_1.TokenKind.EndFunction,
                    startIndex: 0
                }, {
                    text: 'BlaBla',
                    kind: brighterscript_1.TokenKind.Identifier,
                    startIndex: 0
                }], { compositeKeywords: 'split' });
            (0, chai_1.expect)(tokens[0].text).to.equal('end function');
        });
        it('adds spaces at proper locations when supposed to', () => {
            (0, chai_1.expect)(format(['else', brighterscript_1.TokenKind.Else], ['if', brighterscript_1.TokenKind.If])).to.equal('else if');
            (0, chai_1.expect)(format(['endfunction', brighterscript_1.TokenKind.EndFunction])).to.equal('end function');
            (0, chai_1.expect)(format(['endif', brighterscript_1.TokenKind.EndIf])).to.equal('end if');
            (0, chai_1.expect)(format(['endsub', brighterscript_1.TokenKind.EndSub])).to.equal('end sub');
            (0, chai_1.expect)(format(['endwhile', brighterscript_1.TokenKind.EndWhile])).to.equal('end while');
            (0, chai_1.expect)(format(['exitwhile', brighterscript_1.TokenKind.ExitWhile])).to.equal('exit while');
            (0, chai_1.expect)(format(['exitfor', brighterscript_1.TokenKind.ExitFor])).to.equal('exit for');
            (0, chai_1.expect)(format(['endfor', brighterscript_1.TokenKind.EndFor])).to.equal('end for');
            (0, chai_1.expect)(formatter.format(`sub add()\n    if true then\n        a=1\n    elseif true then\n        a=1\n    endif\nendsub`, {
                compositeKeywords: 'split'
            })).to.equal(`sub add()\n    if true then\n        a = 1\n    else if true then\n        a = 1\n    end if\nend sub`);
        });
        ...
        it('handles multi-line arrays', () => {
            ...
            (0, chai_1.expect)(formatter.format(program)).to.equal(`function DoSomething()\n    data = [\n        1,\n        2\n    ]\nend function`);
        });
    });
    ...
    describe('indentStyle', () => {
        describe('conditional block', () => {
            it('correctly fixes the indentation', () => {
                ...
                (0, chai_1.expect)(formatter.format(current)).to.equal(expected);
            });
    ...
    describe('formatWithCodeAndMap', () => {
        it('generates valid sourcemap', async () => {
            ...
            (0, chai_1.expect)(result.code).to.equal(`sub main()\n    print "hello"\nend sub`);
            let consumer = await source_map_1.SourceMapConsumer.fromSourceMap(result.map);
            (0, chai_1.expect)(consumer.generatedPositionFor({
                line: 2,
                column: 0,
                source: 'file.brs'
            })).to.include({
            ...
            (0, chai_1.expect)(consumer.originalPositionFor({
                line: 2,
                column: 4
            })).to.include({
                line: 2,
    ...
    function formatEqual(incoming, expected, options) {
        expected = expected !== null && expected !== void 0 ? expected : incoming;
        let formatted = formatter.format(incoming, options);
        (0, chai_1.expect)(formatted).to.equal(expected);
    }
    /**
     * Same as formatEqual, but smart trims leading whitespace to the indent level of the first character found
     */
    function formatEqualTrim(incoming, expected, options) {
        let sources = [
            incoming,
            expected !== null && expected !== void 0 ? expected : incoming
        ];
