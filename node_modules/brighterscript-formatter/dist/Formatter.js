        ...
        for (let outerLoopCounter = 0; outerLoopCounter <= tokens.length * 2; outerLoopCounter++) {
            ...
            for (let i = 0; i < lineTokens.length; i++) {
                ...
                exports.IndentSpacerTokenKinds.includes(token.kind) &&
                    ...
                    if (parentIndentTokenKind && ((_a = exports.IgnoreIndentSpacerByParentTokenKind.get(parentIndentTokenKind)) === null || _a === void 0 ? void 0 : _a.includes(token.kind))) {
        ...
        for (i; i < tokens.length; i++) {
            ...
            //add/remove whitespace around curly braces
            {
                ...
                token.kind === brighterscript_1.TokenKind.LeftCurlyBrace &&
                    ...
                    (_a = this.getNextNonWhitespaceToken(tokens, i, true)) === null || _a === void 0 ? void 0 : _a.kind)) {
