...
export declare function normalizeOptions(options: FormattingOptions): FormattingOptions;
export declare function normalizeKeywordCaseOverride(obj: FormattingOptions['keywordCaseOverride']): {};
