...
describe('InstallCommand', () => {
    ...
    describe('install', () => {
        ...
        it('processes non-default folder paths', async () => {
            ...
            await command.run();
            chai_1.expect(fsExtra.readFileSync(TestHelpers_spec_1.standardizePath `${projectDir}/nonStandardFolder/roku_modules/logger/logger.brs`).toString()).to.eql('sub logger_log()\nend sub');
        });
        ...
        it('installs nested dependencies', async () => {
            ...
            await command.run();
            chai_1.expect(fsExtra.pathExistsSync(path.join(projectDir, 'source', 'roku_modules', 'maestro_v1'))).to.be.true;
        });
        it('ignores prod dependencies of prod dependencies that are missing the "ropm" keyword', async () => {
            ...
            await command.run();
            chai_1.expect(fsExtra.pathExistsSync(path.join(projectDir, 'source', 'roku_modules', 'maestro_v1'))).to.be.false;
        });
