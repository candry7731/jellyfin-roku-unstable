...
var config = require('../test/testProcessorConfig_coverage.json');
function clearFiles() {
...
describe('CodeCoverageProcessor tests', function () {
    ...
    describe('Process files valid test', function () {
        var _this = this;
        it('tests processor runs', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, processor.process()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('tests creates CodeCoverageSupport file', function () { return __awaiter(_this, void 0, void 0, function () {
            var filePath;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, processor.process()];
                    case 1:
                        _a.sent();
                        filePath = path.resolve(path.join(targetPath, 'source', 'CodeCoverageSupport.brs'));
                        chai_1.expect(fs.existsSync(filePath)).to.be.true;
                        return [2 /*return*/];
                }
            });
        }); });
        it('tests creates coverage component', function () { return __awaiter(_this, void 0, void 0, function () {
            var filePath;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, processor.process()];
                    case 1:
                        _a.sent();
                        filePath = path.resolve(path.join(targetPath, 'components', 'CodeCoverage.xml'));
                        chai_1.expect(fs.existsSync(filePath)).to.be.true;
