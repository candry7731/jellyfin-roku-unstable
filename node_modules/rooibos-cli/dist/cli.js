...
var ProcessorConfig_1 = require("./lib/ProcessorConfig");
var InstallFrameworkCommand_1 = require("./lib/projectCommands/InstallFrameworkCommand");
var RooibosProcessor_1 = require("./lib/RooibosProcessor");
...
program
    ...
    var processorConfig = ProcessorConfig_1.createProcessorConfig(configJson);
    var processor = new RooibosProcessor_1.RooibosProcessor(processorConfig);
...
program
    ...
    .action(function (targetPath, options) {
    var release = options.release || null;
