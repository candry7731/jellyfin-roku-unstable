...
class RokuDeploy {
    ...
    async zipPackage(options) {
        ...
        if (!await util_1.util.fileExistsCaseInsensitive(`${options.stagingFolderPath}/manifest`)) {
    ...
    async createPackage(options, beforeZipCallback) {
        ...
        let manifestPath = util_1.util.standardizePath(`${options.stagingFolderPath}/manifest`);
    ...
    */
    ...
    getOptions(options = {}) {
        ...
        if (finalOptions.stagingFolderPath) {
            ...
            finalOptions.stagingFolderPath = path.resolve(process.cwd(), util_1.util.standardizePath(`${finalOptions.outDir}/.roku-deploy-staging`));
        }
        return finalOptions;
    }
    /**
