...
describe('ConstStatement', () => {
    ...
    let testGetTypedef = (0, testHelpers_spec_1.getTestGetTypedef)(() => [program, rootDir]);
    beforeEach(() => {
    ...
    it('supports basic structure', () => {
        ...
        (0, chai_1.expect)((_a = statement.tokens.const) === null || _a === void 0 ? void 0 : _a.kind).to.eql(TokenKind_1.TokenKind.Const);
        (0, chai_1.expect)(statement.tokens.name).to.include({
            kind: TokenKind_1.TokenKind.Identifier,
            text: 'API_KEY'
        });
        const value = statement.value;
        (0, chai_1.expect)(value).to.be.instanceof(Expression_1.LiteralExpression);
        (0, chai_1.expect)((_b = value.token) === null || _b === void 0 ? void 0 : _b.text).to.eql('"abc"');
        //ensure range is correct
        (0, chai_1.expect)(statement.range).to.eql(util_1.default.createRange(0, 0, 0, 21));
    });
    it('produces typedef', () => {
        testGetTypedef(`
            const API_KEY = "abc"
