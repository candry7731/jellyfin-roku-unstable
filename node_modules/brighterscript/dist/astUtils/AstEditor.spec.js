...
describe('AstEditor', () => {
    ...
    it('arrayPush works', () => {
        ...
        (0, chai_1.expect)(array).to.eql([1, 2, 3, 4]);
        editor.undoAll();
        (0, chai_1.expect)(array).to.eql([1, 2, 3]);
    });
    it('arrayPop works', () => {
        const array = [1, 2, 3];
        (0, chai_1.expect)(editor.arrayPop(array)).to.eql(3);
        (0, chai_1.expect)(array).to.eql([1, 2]);
        editor.undoAll();
        (0, chai_1.expect)(array).to.eql([1, 2, 3]);
    });
    it('arrayShift works', () => {
        const array = [1, 2, 3];
        (0, chai_1.expect)(editor.arrayShift(array)).to.eql(1);
        (0, chai_1.expect)(array).to.eql([2, 3]);
        editor.undoAll();
        (0, chai_1.expect)(array).to.eql([1, 2, 3]);
    });
    it('arrayUnshift works at beginning', () => {
        ...
        (0, chai_1.expect)(array).to.eql([-1, 0, 1, 2, 3]);
        editor.undoAll();
        (0, chai_1.expect)(array).to.eql([1, 2, 3]);
    });
    it('removeProperty removes existing property', () => {
        ...
        (0, chai_1.expect)(obj).not.haveOwnProperty('name');
        editor.undoAll();
        (0, chai_1.expect)(obj).haveOwnProperty('name');
    });
    ...
    it('arraySplice works properly at beginning', () => {
        ...
        (0, chai_1.expect)(arr).to.eql([-1, 0, 3]);
        editor.undoAll();
        (0, chai_1.expect)(arr).to.eql([1, 2, 3]);
    });
    it('arraySplice works properly at the middle', () => {
        const arr = [1, 2, 3];
        editor.arraySplice(arr, 1, 2, 4, 5);
        (0, chai_1.expect)(arr).to.eql([1, 4, 5]);
        editor.undoAll();
        (0, chai_1.expect)(arr).to.eql([1, 2, 3]);
    });
    it('arraySplice works properly at the end', () => {
        ...
        (0, chai_1.expect)(arr).to.eql([1, 2, 3, 4, 5]);
        editor.undoAll();
        (0, chai_1.expect)(arr).to.eql([1, 2, 3]);
    });
    it('edit works', () => {
        ...
        (0, chai_1.expect)(testObj.name).to.eql('new name');
        editor.undoAll();
        (0, chai_1.expect)(testObj.name).to.eql(getTestObject().name);
    });
