...
export declare type WalkVisitor = <T = Statement | Expression>(stmtExpr: Statement | Expression, parent?: Statement | Expression, owner?: any, key?: any) => void | T;
/**
 * A helper function for Statement and Expression `walkAll` calls.
 */
export declare function walk<T>(owner: T, key: keyof T, visitor: WalkVisitor, options: WalkOptions, parent?: Expression | Statement): void;
/**
 ...
 */
export declare function walkArray<T>(array: Array<T>, visitor: WalkVisitor, options: WalkOptions, parent?: Expression | Statement, filter?: <T>(element: T) => boolean): void;
/**
