...
describe('astUtils visitors', () => {
    ...
    describe('Statement editor', () => {
        ...
        it('uses the AstEditor for replacement when provided', () => {
            ...
            (0, chai_1.expect)(block.statements[0]).to.equal(printStatement2);
            editor.undoAll();
            (0, chai_1.expect)(block.statements[0]).to.equal(printStatement1);
        });
    });
    ...
    describe('walk', () => {
        ...
        it('provides owner and key', () => {
            ...
            ast.walk((astNode, parent, owner, key) => {
                items.push(astNode);
                (0, chai_1.expect)(owner[key]).to.equal(astNode);
            }, {
                walkMode: visitors_1.WalkMode.visitAllRecursive
            });
            (0, chai_1.expect)(items).to.be.length(17);
        });
        it('can be used to delete statements', () => {
            ...
            (0, chai_1.expect)(callCount).to.eql(3);
            (0, chai_1.expect)(ast.statements[0].func.body.statements).to.be.lengthOf(0);
        });
        it('can be used to insert statements', () => {
            ...
            //the visitor should have been called for every statement
            (0, chai_1.expect)(printStatementCount).to.eql(3);
            (0, chai_1.expect)(callExpressionCount).to.eql(0);
            (0, chai_1.expect)(ast.statements[0].func.body.statements).to.be.lengthOf(9);
        });
    });
});
