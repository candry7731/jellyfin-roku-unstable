...
describe('import statements', () => {
    ...
    it('adds brs imports to xml file during transpile', () => {
        //create child component
        let component = program.setFile({ src: (0, util_1.standardizePath) `${rootDir}/components/ChildScene.xml`, dest: 'components/ChildScene.xml' }, (0, testHelpers_spec_1.trim) `
            <?xml version="1.0" encoding="utf-8" ?>
            <component name="ChildScene" extends="ParentScene">
                <script type="text/brightscript" uri="pkg:/source/lib.bs" />
            </component>
        `);
        program.setFile({ src: (0, util_1.standardizePath) `${rootDir}/source/lib.bs`, dest: 'source/lib.bs' }, `
            import "stringOps.brs"
            function toLower(strVal as string)
                return StringToLower(strVal)
            end function
        `);
        program.setFile({ src: (0, util_1.standardizePath) `${rootDir}/source/stringOps.brs`, dest: 'source/stringOps.brs' }, `
            function StringToLower(strVal as string)
                return isInt(strVal)
            end function
        `);
