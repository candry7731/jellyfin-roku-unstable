...
describe('HoverProcessor', () => {
    ...
    describe('BrsFile', () => {
        ...
        it('finds top-level constant in assignment expression', () => {
            ...
            `);
            // value += SOME|_VALUE
            let hover = program.getHover('source/main.bs', util_1.default.createPosition(3, 33))[0];
            (0, chai_1.expect)(hover === null || hover === void 0 ? void 0 : hover.range).to.eql(util_1.default.createRange(3, 29, 3, 39));
            (0, chai_1.expect)(hover === null || hover === void 0 ? void 0 : hover.contents).to.eql(fence('const SOME_VALUE = "value"'));
        });
        it('finds namespaced constant in assignment expression', () => {
            ...
            `);
            // value += SOME|_VALUE
            let hover = program.getHover('source/main.bs', util_1.default.createPosition(3, 47))[0];
            (0, chai_1.expect)(hover === null || hover === void 0 ? void 0 : hover.range).to.eql(util_1.default.createRange(3, 43, 3, 53));
            (0, chai_1.expect)(hover === null || hover === void 0 ? void 0 : hover.contents).to.eql(fence('const someNamespace.SOME_VALUE = "value"'));
        });
