...
function addEolLast(diagnostic) {
    ...
    return {
        diagnostic,
        changes: [
            textEdit_1.insertText(diagnostic.range.end, (_a = 
            // In single line files, the `preferredEol` cannot be determined
            // e.g: `sub foo() end sub\EOF`
            diagnostic.data.preferredEol) !== null && _a !== void 0 ? _a : (process_1.platform.toString() === 'win32' ? '\r\n' : '\n'))
        ]
    };
}
function removeEolLast(diagnostic) {
    return {
        diagnostic,
        changes: [
            textEdit_1.replaceText(diagnostic.range, '')
        ]
    };
}
