sub init()
    m.top.keyGrid.keyDefinitionUri = "pkg:/components/roku_modules/intkeyboard/integerKeyboardKDF.json"
    m.top.textEditBox.maxTextLength = m.top.maxLength
    m.top.observeField("maxLength", "intkeyboard_onMaxLengthChanged")
end sub

sub intkeyboard_onMaxLengthChanged()
    m.top.textEditBox.maxTextLength = m.top.maxLength
end sub
