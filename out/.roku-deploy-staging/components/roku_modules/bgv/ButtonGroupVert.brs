sub init()
    ...
    m.top.observeField("focusedChild", "bgv_onFocusChanged")
    m.top.observeField("focusButton", "bgv_onFocusButtonChanged")
end sub

sub bgv_onFocusChanged()
    if m.top.hasFocus()
